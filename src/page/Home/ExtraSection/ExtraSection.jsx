...
const ExtraSection = () => {
    return (
        <>
            <div   data-aos-anchor-placement="top-center"   data-aos="fade-down"    className=" grid md:grid-cols-2 gap-4  items-center    bg-slate-200">

                <div   data-aos-anchor-placement="top-center"    data-aos="fade-up" className='  lg:w-1/2'>
                ...
                <div  data-aos-anchor-placement="top-center"    data-aos="fade-up"  className='  lg:w-full'>
                    <div className='flex gap-4 mt-5 mb-4 me-4 shadow-2xl'>
                        ...
                        <div  data-aos-anchor-placement="top-center"    data-aos="fade-up"  className=' data-aos="fade-up"  gap-4 bg-slate-50 py-6 px-10 text-center'>
                    ...
                    <div   data-aos-anchor-placement="top-center"   className='   flex gap-4 mt-4 text-center me-4 mb-4'>
